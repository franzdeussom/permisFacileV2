...
To build the final jar and optimize the PermisFacileV2 application for production, run:
...
To build the final jar and optimize the permisfacile application for production, run:
...
scp target/permis-facile-v-2-0.0.1-SNAPSHOT.jar root@198.71.48.43:~/

ssh root@198.71.48.43
