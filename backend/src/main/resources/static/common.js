...
/***/ 373:
/*!******************************************************!*\
  !*** ./src/app/pages/entities/details-id.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DetailsParamService": () => (/* binding */ DetailsParamService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 3184);


let DetailsParamService = class DetailsParamService {
    constructor() { this.isFavouriteTab = false; }
    setIdQuestion(id, quizz, isFavouriteTab) {
        this.id = id;
        this.quizz = quizz;
...
DetailsParamService.ctorParameters = () => [];
DetailsParamService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/***/ 500:
/*!**********************************************************************!*\
  !*** ./src/app/pages/entities/favourite-list/favourite-list.page.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FavouriteListPage": () => (/* binding */ FavouriteListPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _favourite_list_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./favourite-list.page.html?ngResource */ 2146);
/* harmony import */ var _favourite_list_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./favourite-list.page.scss?ngResource */ 5);
/* harmony import */ var _details_id_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../details-id.service */ 373);
...
let FavouriteListPage = class FavouriteListPage {
    constructor(getQuestion, localSave, goDetail, detailParam) {
    ...
    goToDetails(idQuestion, question) {
...
FavouriteListPage.ctorParameters = () => [
    ...
    { type: _details_id_service__WEBPACK_IMPORTED_MODULE_2__.DetailsParamService }
];
FavouriteListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-favourite-list',
        template: _favourite_list_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_favourite_list_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], FavouriteListPage);
...
/***/ 6244:
/*!******************************************************!*\
  !*** ./src/app/pages/entities/local-save.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LocalSaveService": () => (/* binding */ LocalSaveService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _question_globalService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./question/globalService */ 5546);
...
let LocalSaveService = class LocalSaveService {
    constructor(globalService) {
        this.globalService = globalService;
        this.defaultQuestionTab = this.globalService.globalQuestion;
    }
    localSave(question, isFavouriteTab) {
...
LocalSaveService.ctorParameters = () => [
    { type: _question_globalService__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
LocalSaveService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/***/ 3016:
/*!**********************************************************!*\
  !*** ./src/app/pages/home/check-account-type.service.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CheckAccountTypeService": () => (/* binding */ CheckAccountTypeService)
/* harmony export */ });
...
let CheckAccountTypeService = class CheckAccountTypeService {
    constructor(api) {
        this.api = api;
    }
    isAdmin() {
        this.api.get('account').subscribe((resp) => {
            if (resp.firstName === 'Administrator') {
                this.isAdministrator = true;
            }
            console.log(resp);
            console.log('isAdmin ?:', this.isAdministrator);
        });
    }
};
CheckAccountTypeService.ctorParameters = () => [
    { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_0__.ApiService }
];
CheckAccountTypeService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony import */ var _ionic_native_device_ngx_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/device/ngx/index */ 8104);
...
let LoginPage = class LoginPage {
    constructor(translateService, loginService, toastController, navController, device) {
...
LoginPage.ctorParameters = () => [
    ...
    { type: _ionic_native_device_ngx_index__WEBPACK_IMPORTED_MODULE_3__.Device }
];
...
/* harmony export */ });
/* harmony import */ var _Users_guymoyo_dev_permisfacilev2_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_guymoyo_dev_permisfacilev2_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_guymoyo_dev_permisfacilev2_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_guymoyo_dev_permisfacilev2_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 5:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/entities/favourite-list/favourite-list.page.scss?ngResource ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = "#favv {\n  font-size: 25px;\n  padding-left: 10px;\n}\n\n.favourite {\n  color: yellow;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = ".backGround {\n  --background: #259bbe;\n}\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbImxvZ2luLnBhZ2Uuc2NzcyJdLCJuYW1lcyI6W10sIm1hcHBpbmdzIjoiQUFBQTtFQUNJLHFCQUFBO0FBQ0oiLCJmaWxlIjoibG9naW4ucGFnZS5zY3NzIiwic291cmNlc0NvbnRlbnQiOlsiLmJhY2tHcm91bmR7XG4gICAgLS1iYWNrZ3JvdW5kOiAjMjU5YmJlO1xufSJdfQ== */";

/***/ }),

/***/ 2146:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/entities/favourite-list/favourite-list.page.html?ngResource ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = "<ion-header>\n  <ion-toolbar color=\"tertiary\">\n    <ion-back-button slot=\"start\"></ion-back-button>\n    <ion-title>My favourites</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-margin\">\n      <span> {{ nbrFav }} favourites</span>\n  </div>\n  <ion-card class=\"ion-padding\">\n      <ion-list>\n          <div *ngFor=\"let item of question; let index = index\" >\n            <ion-item *ngIf=\"question[index].favourite\" (click)=\"goToDetails(index, question)\">\n              <ion-label text-wrap><sup><em>{{ index+1 }}</em></sup> {{ question[index].intitule }} </ion-label>\n              <span (click)=\"unsetFavourite(index)\" id=\"favv\" class=\"favourite\">\n                <ion-icon name='star' slot=\"end\"></ion-icon>\n              </span>\n            </ion-item>\n          </div>\n       </ion-list>\n  </ion-card>\n</ion-content>\n";
